...
প্রথম ধাপ<br>
( 5 1 4 2 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 5 4 2 8 ), এখানে, প্রথম দুটি উপাদানের মধ্যে তুলনা করবে, এবং যেহেতু 5 > 1 সেহেতু স্থান পরিবর্তন করবে।<br>
( 1 5 4 2 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 4 5 2 8 ), যেহেতু 5 > 4 সেহেতু স্থান পরিবর্তন করবে.।<br>
( 1 4 5 2 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 4 2 5 8 ), যেহেতু 5 > 2 সেহেতু স্থান পরিবর্তন করবে।<br>
( 1 4 2 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 4 2 5 8 ), এখন, যেহেতু (8 > 5), সেহেতু স্থান পরিবর্তন করবে না।<br>

দ্বিতীয় ধাপ <br>
( 1 4 2 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 4 2 5 8 ) <br>
( 1 4 2 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 ), যেহেতু 4 > 2 সেহেতু স্থান পরিবর্তন করবে।<br>
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br>
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br>
এখন, এই উপাদানগুলো ক্রমানুসারে আছে,কিন্তু অ্যালগোরিদমটি অ্যারের উপাদানগুলো সর্ট হয়েছে বা ক্রমানুসারে আছে কি না সেটা নিশ্চিত নয়। উপাদানগুলো ক্রমানুসারে আছে সেটা নির্ধারণ করার জন্য উপাদানগুলোর স্থান পরিবর্তন না করে পুনরায় একটি পূর্ণাঙ্গ ধাপের দরকার হয় ।<br>

তৃতীয় ধাপ
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br>
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br>
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br>
( 1 2 4 5 8 ) {\displaystyle \to }{\displaystyle \to } ( 1 2 4 5 8 )<br /><br />
            Complexity:<br />
